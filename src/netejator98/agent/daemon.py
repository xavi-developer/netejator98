    ...
    def _create_default_policy(self) -> CleaningPolicy:
        ...
        targets = [
            ...
            CleaningTarget(
                ...
                os="Linux",
                category=TargetCategory.BROWSER_PROFILES,
                strategy=DeletionStrategy.BROWSER_CLEAN,
                description="Google Chrome - Favorites, history, cache, cookies, sessions (Linux)",
                enabled=False,
                patterns=(
                    PathPattern(".config/google-chrome/Default/Bookmarks*"),
                    PathPattern(".config/google-chrome/Default/History*"),
                    PathPattern(".config/google-chrome/Default/Cookies*"),
                    PathPattern(".config/google-chrome/Default/Sessions/*"),
                    PathPattern(".config/google-chrome/Default/Cache/*"),
                    PathPattern(".cache/google-chrome/*"),
                ),
            ),
            CleaningTarget(
                ...
                category=TargetCategory.BROWSER_PROFILES,
                strategy=DeletionStrategy.BROWSER_CLEAN,
                description="Mozilla Firefox - History, bookmarks, cache, cookies, sessions (Linux)",
                enabled=False,
                patterns=(
                    PathPattern(".mozilla/firefox/*.default*/places.sqlite*"),
                    PathPattern(".mozilla/firefox/*.default*/cookies.sqlite*"),
                    PathPattern(".mozilla/firefox/*.default*/sessionstore*"),
                    PathPattern(".mozilla/firefox/*.default*/cache2/*"),
                    PathPattern(".cache/mozilla/firefox/*"),
                ),
            ),
            CleaningTarget(
                ...
                category=TargetCategory.BROWSER_PROFILES,
                strategy=DeletionStrategy.BROWSER_CLEAN,
                description="Microsoft Edge - Favorites, history, cache, cookies (Linux)",
                enabled=False,
                patterns=(
                    PathPattern(".config/microsoft-edge/Default/Bookmarks*"),
                    PathPattern(".config/microsoft-edge/Default/History*"),
                    PathPattern(".config/microsoft-edge/Default/Cookies*"),
                    PathPattern(".config/microsoft-edge/Default/Cache/*"),
                ),
            ),
            CleaningTarget(
                name="BrowserBrave",
                ...
                category=TargetCategory.BROWSER_PROFILES,
                strategy=DeletionStrategy.BROWSER_CLEAN,
                description="Brave Browser - Favorites, history, cache, cookies (Linux)",
                enabled=False,
                patterns=(
                    PathPattern(".config/BraveSoftware/Brave-Browser/Default/Bookmarks*"),
                    PathPattern(".config/BraveSoftware/Brave-Browser/Default/History*"),
                    PathPattern(".config/BraveSoftware/Brave-Browser/Default/Cookies*"),
                    PathPattern(".config/BraveSoftware/Brave-Browser/Default/Cache/*"),
                ),
            ),
            CleaningTarget(
                name="BrowserOpera",
                ...
                category=TargetCategory.BROWSER_PROFILES,
                strategy=DeletionStrategy.BROWSER_CLEAN,
                description="Opera Browser - Favorites, history, cache, cookies (Linux)",
                enabled=False,
                patterns=(
                    PathPattern(".config/opera/Bookmarks*"),
                    PathPattern(".config/opera/History*"),
                    PathPattern(".config/opera/Cookies*"),
                    PathPattern(".cache/opera/*"),
                ),
            ),
            CleaningTarget(
                ...
                category=TargetCategory.BROWSER_PROFILES,
                strategy=DeletionStrategy.BROWSER_CLEAN,
                description="Chromium - Favorites, history, cache, cookies (Linux)",
                enabled=False,
                patterns=(
                    PathPattern(".config/chromium/Default/Bookmarks*"),
                    PathPattern(".config/chromium/Default/History*"),
                    PathPattern(".config/chromium/Default/Cookies*"),
                    PathPattern(".cache/chromium/*"),
                ),
            ),
            CleaningTarget(
                name="UserDocuments",
            ...
            CleaningTarget(
                ...
                category=TargetCategory.BROWSER_PROFILES,
                strategy=DeletionStrategy.BROWSER_CLEAN,
                description="Google Chrome - Favorites, history, cache, cookies (Windows)",
                enabled=False,
                patterns=(
                    PathPattern("AppData/Local/Google/Chrome/User Data/Default/Bookmarks*"),
                    PathPattern("AppData/Local/Google/Chrome/User Data/Default/History*"),
                    PathPattern("AppData/Local/Google/Chrome/User Data/Default/Network/Cookies*"),
                    PathPattern("AppData/Local/Google/Chrome/User Data/Default/Cache/*"),
                ),
            ),
            CleaningTarget(
                name="BrowserMozillaFirefox",
                ...
                category=TargetCategory.BROWSER_PROFILES,
                strategy=DeletionStrategy.BROWSER_CLEAN,
                description="Mozilla Firefox - History, bookmarks, cache, cookies (Windows)",
                enabled=False,
                patterns=(
                    PathPattern("AppData/Roaming/Mozilla/Firefox/Profiles/*.default*/places.sqlite*"),
                    PathPattern("AppData/Roaming/Mozilla/Firefox/Profiles/*.default*/cookies.sqlite*"),
                    PathPattern("AppData/Local/Mozilla/Firefox/Profiles/*.default*/cache2/*"),
                ),
            ),
            CleaningTarget(
                name="BrowserMicrosoftEdge",
                ...
                category=TargetCategory.BROWSER_PROFILES,
                strategy=DeletionStrategy.BROWSER_CLEAN,
                description="Microsoft Edge - Favorites, history, cache, cookies (Windows)",
                enabled=False,
                patterns=(
                    PathPattern("AppData/Local/Microsoft/Edge/User Data/Default/Bookmarks*"),
                    PathPattern("AppData/Local/Microsoft/Edge/User Data/Default/History*"),
                    PathPattern("AppData/Local/Microsoft/Edge/User Data/Default/Network/Cookies*"),
                    PathPattern("AppData/Local/Microsoft/Edge/User Data/Default/Cache/*"),
                ),
            ),
            CleaningTarget(
                name="BrowserBrave",
                ...
                category=TargetCategory.BROWSER_PROFILES,
                strategy=DeletionStrategy.BROWSER_CLEAN,
                description="Brave Browser - Favorites, history, cache, cookies (Windows)",
                enabled=False,
                patterns=(
                    PathPattern("AppData/Local/BraveSoftware/Brave-Browser/User Data/Default/Bookmarks*"),
                    PathPattern("AppData/Local/BraveSoftware/Brave-Browser/User Data/Default/History*"),
                    PathPattern("AppData/Local/BraveSoftware/Brave-Browser/User Data/Default/Network/Cookies*"),
                    PathPattern("AppData/Local/BraveSoftware/Brave-Browser/User Data/Default/Cache/*"),
                ),
            ),
            CleaningTarget(
                name="BrowserOpera",
                ...
                category=TargetCategory.BROWSER_PROFILES,
                strategy=DeletionStrategy.BROWSER_CLEAN,
                description="Opera Browser - Favorites, history, cache, cookies (Windows)",
                enabled=False,
                patterns=(
                    PathPattern("AppData/Roaming/Opera Software/Opera Stable/Bookmarks*"),
                    PathPattern("AppData/Roaming/Opera Software/Opera Stable/History*"),
                    PathPattern("AppData/Roaming/Opera Software/Opera Stable/Network/Cookies*"),
                    PathPattern("AppData/Local/Opera Software/Opera Stable/Cache/*"),
                ),
            ),
            CleaningTarget(
                name="BrowserChromium",
                ...
                category=TargetCategory.BROWSER_PROFILES,
                strategy=DeletionStrategy.BROWSER_CLEAN,
                description="Chromium - Favorites, history, cache, cookies (Windows)",
                enabled=False,
                patterns=(
                    PathPattern("AppData/Local/Chromium/User Data/Default/Bookmarks*"),
                    PathPattern("AppData/Local/Chromium/User Data/Default/History*"),
                    PathPattern("AppData/Local/Chromium/User Data/Default/Network/Cookies*"),
                    PathPattern("AppData/Local/Chromium/User Data/Default/Cache/*"),
                ),
            ),
            CleaningTarget(
                name="UserDocuments",
            ...
            CleaningTarget(
                ...
                category=TargetCategory.BROWSER_PROFILES,
                strategy=DeletionStrategy.BROWSER_CLEAN,
                description="Safari - History, bookmarks, cache, cookies (macOS)",
                enabled=False,
                patterns=(
                    PathPattern("Library/Safari/Bookmarks.plist"),
                    PathPattern("Library/Safari/History.db*"),
                    PathPattern("Library/Cookies/Cookies.binarycookies"),
                    PathPattern("Library/Caches/com.apple.Safari/*"),
                ),
            ),
            CleaningTarget(
                name="BrowserGoogleChrome",
                ...
                category=TargetCategory.BROWSER_PROFILES,
                strategy=DeletionStrategy.BROWSER_CLEAN,
                description="Google Chrome - Favorites, history, cache, cookies (macOS)",
                enabled=False,
                patterns=(
                    PathPattern("Library/Application Support/Google/Chrome/Default/Bookmarks*"),
                    PathPattern("Library/Application Support/Google/Chrome/Default/History*"),
                    PathPattern("Library/Application Support/Google/Chrome/Default/Cookies*"),
                    PathPattern("Library/Caches/Google/Chrome/*"),
                ),
            ),
            CleaningTarget(
                name="BrowserMozillaFirefox",
                ...
                category=TargetCategory.BROWSER_PROFILES,
                strategy=DeletionStrategy.BROWSER_CLEAN,
                description="Mozilla Firefox - History, bookmarks, cache, cookies (macOS)",
                enabled=False,
                patterns=(
                    PathPattern("Library/Application Support/Firefox/Profiles/*.default*/places.sqlite*"),
                    PathPattern("Library/Application Support/Firefox/Profiles/*.default*/cookies.sqlite*"),
                    PathPattern("Library/Caches/Firefox/Profiles/*.default*/cache2/*"),
                ),
            ),
            CleaningTarget(
                name="BrowserMicrosoftEdge",
                ...
                category=TargetCategory.BROWSER_PROFILES,
                strategy=DeletionStrategy.BROWSER_CLEAN,
                description="Microsoft Edge - Favorites, history, cache, cookies (macOS)",
                enabled=False,
                patterns=(
                    PathPattern("Library/Application Support/Microsoft Edge/Default/Bookmarks*"),
                    PathPattern("Library/Application Support/Microsoft Edge/Default/History*"),
                    PathPattern("Library/Application Support/Microsoft Edge/Default/Cookies*"),
                    PathPattern("Library/Caches/Microsoft Edge/*"),
                ),
            ),
            CleaningTarget(
                name="BrowserBrave",
                ...
                category=TargetCategory.BROWSER_PROFILES,
                strategy=DeletionStrategy.BROWSER_CLEAN,
                description="Brave Browser - Favorites, history, cache, cookies (macOS)",
                enabled=False,
                patterns=(
                    PathPattern("Library/Application Support/BraveSoftware/Brave-Browser/Default/Bookmarks*"),
                    PathPattern("Library/Application Support/BraveSoftware/Brave-Browser/Default/History*"),
                    PathPattern("Library/Application Support/BraveSoftware/Brave-Browser/Default/Cookies*"),
                    PathPattern("Library/Caches/BraveSoftware/*"),
                ),
            ),
            CleaningTarget(
                name="BrowserOpera",
                ...
                category=TargetCategory.BROWSER_PROFILES,
                strategy=DeletionStrategy.BROWSER_CLEAN,
                description="Opera Browser - Favorites, history, cache, cookies (macOS)",
                enabled=False,
                patterns=(
                    PathPattern("Library/Application Support/com.operasoftware.Opera/Bookmarks*"),
                    PathPattern("Library/Application Support/com.operasoftware.Opera/History*"),
                    PathPattern("Library/Application Support/com.operasoftware.Opera/Cookies*"),
                    PathPattern("Library/Caches/com.operasoftware.Opera/*"),
                ),
            ),
        ]
